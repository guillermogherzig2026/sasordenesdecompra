...
final class NavigationPermissionCatalog
{
    ...
    public static function permissionsForRequest(Request $request): array
    {
        ...
        if (Str::startsWith($routeName, 'human-resources.')) {
            $section = (string) ($request->route('section') ?? 'inicio');

            return [match ($section) {
                'candidatos' => 'human_resources.candidates',
                'contratos' => 'human_resources.contracts',
                'empleados' => 'human_resources.employees',
                'aprobaciones' => 'human_resources.pending_approvals',
                'nomina' => 'human_resources.payroll',
                'horas-extra' => 'human_resources.overtime',
                'reportes' => 'human_resources.reports',
                'configuracion' => 'human_resources.configuration',
                'gerentes' => 'human_resources.managers_branches',
                default => 'human_resources.dashboard',
            }];
        }
