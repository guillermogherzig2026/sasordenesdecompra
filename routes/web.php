...
Route::middleware(['auth', EnforceNavigationPermission::class])->prefix('recursos-humanos')->name('human-resources.')->group(function () {
    Route::get('/', [HumanResourcesController::class, 'show'])->name('index');
