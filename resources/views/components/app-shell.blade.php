@php
    ...
    $superAdminNavGroups = [
        ...
        'Recursos Humanos' => [
            ...
            ['label' => 'Pendientes de Aprobación', 'url' => route('human-resources.show', 'aprobaciones'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'aprobaciones'],
            ['label' => 'Nómina', 'url' => route('human-resources.show', 'nomina'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'nomina'],
            ['label' => 'Horas extras', 'url' => route('human-resources.show', 'horas-extra'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'horas-extra'],
            ['label' => 'Reportes', 'url' => route('human-resources.show', 'reportes'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'reportes'],
            ['label' => 'Configuración', 'url' => route('human-resources.show', 'configuracion'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'configuracion'],
            ['label' => 'Gerentes y Sucursales', 'url' => route('human-resources.show', 'gerentes'), 'active' => request()->routeIs('human-resources.show') && request()->route('section') === 'gerentes'],
        ],
