...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-shell','data' => ['title' => 'OP Pendientes']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'OP Pendientes']); ?>
        <section class="panel">
            <div class="panel-header">
                ...
                <form class="toolbar" method="GET" action="<?php echo e(route('finance.construction-payment-orders.active')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Revision OC Software\resources\views/finance/construction-payment-orders/active.blade.php ENDPATH**/ ?>