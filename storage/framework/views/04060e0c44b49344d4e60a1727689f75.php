...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title><?php echo e($order->folio); ?></title>
        <style>
        ...
        <main class="sheet">
            <section class="oc-frame">
                <header class="top-header">
                    <div class="brand">
                        <?php if($order->company->logo_path): ?>
                            <img class="brand-logo" src="<?php echo e(route('companies.logo', $order->company)); ?>" alt="<?php echo e($order->company->name); ?>">
                        <?php else: ?>
                            <div class="brand-mark"><?php echo e($order->company->initials()); ?></div>
                        <?php endif; ?>
                    </div>
                    <div class="company-title">
                        <div><?php echo e($order->company->name); ?></div>
                    </div>
                </header>
                ...
                <section class="info-grid">
                    <div class="info-row">
                        ...
                        <div class="value center"><?php echo e(str_replace('OC-', 'OC', $order->folio)); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="label">Fecha de elaboracion:</div>
                        <div class="value center"><?php echo e($order->created_on?->format('d-M-y')); ?></div>
                    </div>
                ...
                <section class="provider-grid">
                    <div class="provider-left">
                        ...
                        <div class="provider-values">
                            <div class="strong"><?php echo e($order->provider->business_name); ?></div>
                            <div>RFC: <?php echo e($order->provider->rfc); ?></div>
                            <div><?php echo e($order->provider->bank); ?> cuenta: <?php echo e($order->provider->account_number); ?></div>
                            <div>Clabe: <?php echo e($order->provider->clabe); ?></div>
                            <br>
                            <div>N/A</div>
                            <br>
                            <div><?php echo e($order->buyer->name); ?></div>
                            <div>N/A</div>
                        </div>
                    </div>
                    <div class="provider-right">
                        ...
                        <div class="value-stack">
                            <div><?php echo e($orderReference ?: 'N/A'); ?></div>
                            <div><?php echo e($order->provider->business_line); ?></div>
                            <div><?php echo e($order->payment_concept ?: 'N/A'); ?></div>
                            <div>N/A</div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div class="delivery-row">
                        ...
                        <div class="value center"><?php echo e($order->delivery_date?->format('d-M-Y')); ?></div>
                    ...
                    <div class="billing">
                        ...
                        <div class="value strong"><?php echo e($order->company->name); ?></div>
                        <div class="label">Direccion.</div>
                        <div class="value"><?php echo e($order->company->address); ?></div>
                        <div class="label">R.F.C.</div>
                        <div class="value"><?php echo e($order->company->rfc); ?> <span class="strong" style="margin-left: 120px;">USO DE CFDI:</span> Adquisicion de mercancia</div>
                ...
                <section>
                    <table class="items">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="partida"><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($item->article); ?></td>
                                    <td class="cantidad"><?php echo e(number_format((float) $item->quantity, 0)); ?></td>
                                    <td class="money">$<?php echo e(number_format((float) $item->unit_price, 3)); ?></td>
                                    <td class="money">$<?php echo e(number_format((float) $item->line_total, 2)); ?></td>
                                </tr>
                    ...
                    <table class="totals">
                        <tr><td>SUBTOTAL ORDEN</td><td class="amount">$<?php echo e(number_format($subtotal, 2)); ?></td></tr>
                        <tr><td>DESCUENTO</td><td class="amount">$<?php echo e(number_format($discount, 2)); ?></td></tr>
                        <tr><td>SUBTOTAL CON DESC.</td><td class="amount">$<?php echo e(number_format($subtotalWithDiscount, 2)); ?></td></tr>
                        <tr><td>I.V.A. 16%</td><td class="amount">$<?php echo e(number_format($iva, 2)); ?></td></tr>
                        <tr><td class="grand">TOTAL</td><td class="amount grand">$<?php echo e(number_format($total, 2)); ?></td></tr>
                    </table>
                </section>

                <section class="notes-wrap">
                    <div class="notes-title">Observaciones</div>
                    <div class="notes-body"><?php echo e($notes); ?></div>
                </section>
...
<?php /**PATH C:\laragon\www\Revision OC Software\resources\views\finance\orders\print.blade.php ENDPATH**/ ?>