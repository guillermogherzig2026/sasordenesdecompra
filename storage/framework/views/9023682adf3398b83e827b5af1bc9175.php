    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .unit-price-table { min-width: 1120px; table-layout: fixed; }
            ...
            .unit-price-table th:nth-child(1), .unit-price-table td:nth-child(1) { width: 125px; }
            .unit-price-table th:nth-child(2), .unit-price-table td:nth-child(2) { width: auto; }
            .unit-price-table th:nth-child(3), .unit-price-table td:nth-child(3) { width: 90px; text-align: center; }
            .unit-price-table th:nth-child(n+4), .unit-price-table td:nth-child(n+4) { width: 155px; text-align: right; }
