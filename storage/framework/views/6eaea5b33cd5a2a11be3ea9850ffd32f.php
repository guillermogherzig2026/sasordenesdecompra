...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-shell','data' => ['title' => 'OS Historial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'OS Historial']); ?>
        <section class="panel">
            <div class="panel-header">
                ...
                <form class="toolbar" method="GET" action="<?php echo e(route('finance.supply-orders.history')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.supply-order-items-dialog','data' => ['order' => $order,'dialogId' => 'finance-history-supply-detail-'.$order->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['order' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order),'dialog-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('finance-history-supply-detail-'.$order->id)]); ?>
...
<?php endif; ?>
                                ...
                                <td>
                                    <?php if($order->delivery_remission_number): ?>
                                        ...
                                        <?php if($order->received_on): ?>
                                            <div class="fine-print">Recibida <?php echo e($order->received_on->format('d/m/Y')); ?></div>
                                        <?php endif; ?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Revision OC Software\resources\views\finance\supply-orders\history.blade.php ENDPATH**/ ?>