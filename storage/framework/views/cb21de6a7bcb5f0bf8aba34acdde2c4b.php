...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-shell','data' => ['title' => $pageTitle]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pageTitle)]); ?>
        <?php if($downloadReport): ?>
             <?php $__env->slot('actions', null, []); ?> 
                <a class="button ghost" href="<?php echo e(route('reports.download', $downloadReport)); ?>">Descarga para filtrar</a>
             <?php $__env->endSlot(); ?>
        <?php endif; ?>
                ...
                <div class="panel-header service-month-header service-month-header-compact">
                    <button class="month-toggle" type="button" data-month-toggle
                        ...
                        <span class="month-toggle-copy">
                            <h2><?php echo e($month['label']); ?> <span class="month-total-inline">Total:
                                    $<?php echo e(number_format((float) $month['total'], 0)); ?></span></h2>
                            <span class="fine-print"><?php echo e($monthSubtitle); ?></span>
                        </span>
                    </button>
                    <div class="month-summary-metrics">
                        <article class="metric-card compact-metric">
                            <span><?php echo e($metricLabels['total']); ?></span>
                            <strong>$<?php echo e(number_format((float) $month['total'], 2)); ?></strong>
                        </article>

                        <article class="metric-card compact-metric">
                            <span><?php echo e($metricLabels['paid']); ?></span>
                            <strong>$<?php echo e(number_format((float) $month['paid_total'], 2)); ?></strong>
                        </article>

                        <article class="metric-card compact-metric">
                            <span><?php echo e($metricLabels['next_week']); ?></span>
                            <strong>$<?php echo e(number_format((float) $next_week_total, 2)); ?></strong>
                        </article>

                        <article class="metric-card compact-metric">
                            <span><?php echo e($metricLabels['pending']); ?></span>
                        ...
                        <table class="service-month-table" data-column-filter-table>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $month['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <tr data-filter-row class="<?php echo \Illuminate\Support\Arr::toCssClasses(['service-row-locked' => $historyMode || ($paid && !$isDomiciled)]); ?>">
                                        <td data-filter-value="<?php echo e($item['service']->folio); ?>">
                                            <strong><?php echo e($item['service']->folio); ?></strong>
                                        </td>
                                        <td
                                            data-filter-value="<?php echo e($item['service']->holder ?: $item['service']->company_name); ?>">
                                            <?php echo e($item['service']->holder ?: $item['service']->company_name); ?></td>
                                        <td data-filter-value="<?php echo e($item['service']->display_branch); ?>">
                                            <?php echo e($item['service']->display_branch); ?></td>
                                        <td data-filter-value="<?php echo e($item['service']->service_name); ?>">
                                            <?php echo e($item['service']->service_name); ?></td>
                                        <td data-filter-value="<?php echo e($item['service']->bank); ?>"><?php echo e($item['service']->bank); ?>

                                        </td>
                                        <td data-filter-value="<?php echo e($item['service']->payer_account); ?>">
                                            <?php echo e($item['service']->payer_account); ?></td>
                                        <td data-filter-value="<?php echo e($item['service']->provider); ?>">
                                            <?php echo e($item['service']->provider); ?></td>
                                        <td data-filter-value="<?php echo e($item['service']->service_number); ?>">
                                            <?php echo e($item['service']->service_number); ?></td>
                                        <td
                                            data-filter-value="<?php echo e(\Illuminate\Support\Carbon::parse($item['period_start'])->format('d/m/Y')); ?> al <?php echo e(\Illuminate\Support\Carbon::parse($item['due_date'])->format('d/m/Y')); ?>">
                                            <?php echo e(\Illuminate\Support\Carbon::parse($item['period_start'])->format('d/m')); ?>

                                            al <?php echo e(\Illuminate\Support\Carbon::parse($item['due_date'])->format('d/m')); ?>

                                        </td>
                                        <td data-filter-value="<?php echo e($paymentDueDate->format('d/m/Y')); ?>"
                                            data-filter-date="<?php echo e($paymentDueDate->format('Y-m-d')); ?>">
                                            <?php echo e($paymentDueDate->format('d/m/Y')); ?></td>
                                        <td data-filter-value="$<?php echo e(number_format($periodAmount, 2)); ?>">
                                            <?php if($historyMode || ($paid && !$isDomiciled)): ?>
                                                $<?php echo e(number_format($periodAmount, 2)); ?>

                                            <?php else: ?>
                                                <form class="amount-edit" method="POST"
                                                    action="<?php echo e(route('services.amount.update', [$item['service'], $item['due_date']])); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <input name="amount" type="number" min="0" step="0.01"
                                                        value="<?php echo e(number_format($periodAmount, 2, '.', '')); ?>" required>
                                                    <button class="button ghost small" type="submit">Guardar</button>
                                                </form>
                                            <?php endif; ?>
                                        </td>
                                        <td data-filter-value="<?php echo e($item['service']->reference); ?>">
                                            <?php echo e($item['service']->reference); ?></td>
                                        <td data-filter-value="<?php echo e($statusText); ?>">
                                            <details class="status-menu">
                                                ...
                                                <div class="status-menu-panel">
                                                    <span
                                                        class="fine-print"><?php echo e($isDomiciled ? 'Pago domiciliado automatico' : ($paid ? 'Bloqueado por pago' : 'Estado de factura')); ?></span>
                                                </div>
                                            </details>
                                        </td>
                                        ...
                                        <td data-filter-value="<?php echo e($receipt?->support_original_name ?: 'Pendiente'); ?>">
                                            <?php if($receipt?->support_original_name): ?>
                                                <div class="item-actions">
                                                    <a class="attachment-pill"
                                                        href="<?php echo e(route('services.support-file', $receipt)); ?>"
                                                        target="_blank"
                                                        rel="noopener"><span>Adjunto</span><?php echo e($receipt->support_original_name); ?></a>
                                                    <?php if(! $historyMode && $item['service']->status !== 'inactive' && (!$paid || $isDomiciled)): ?>
                                                        <a class="button ghost small"
                                                            href="<?php echo e(route('services.receipt', [$item['service'], $item['due_date']])); ?>">Cambiar
                                                            factura</a>
                                                    <?php elseif($paid): ?>
                                            ...
                                            <?php else: ?>
                                                <?php if(! $historyMode && $item['service']->status !== 'inactive'): ?>
                                                    <a class="button primary small"
                                                        href="<?php echo e(route('services.receipt', [$item['service'], $item['due_date']])); ?>">Subir
                                                        factura</a>
                                                <?php else: ?>
                                                    Pendiente
                                                <?php endif; ?>
                                        ...
                                        <td
                                            data-filter-value="<?php echo e($isDomiciled ? 'DOM' : $receipt?->payment_original_name ?? 'Pendiente'); ?>">
                                            <?php if($isDomiciled): ?>
                                                DOM
                                            <?php elseif($receipt?->payment_file_path): ?>
                                                <a class="attachment-pill"
                                                    href="<?php echo e(route('services.payment-file', $receipt)); ?>" target="_blank"
                                                    rel="noopener"><span>Adjunto</span><?php echo e($receipt->payment_original_name ?: 'Comprobante'); ?></a>
                                            <?php else: ?>
                                                Pendiente
                                            <?php endif; ?>
                                        </td>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="15"><?php echo e($emptyMessage); ?></td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Revision OC Software\resources\views\services\months.blade.php ENDPATH**/ ?>