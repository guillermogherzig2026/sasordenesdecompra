                    ...
                    <details class="nav-group" <?php echo e($groupIsActive ? 'open' : ''); ?>>
                        ...
                        <div class="nav-sublist">
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(($item['children'] ?? []) && $item['active']): ?>
                                    <div class="nav-inline-flow">
                                        <span class="nav-box-title"><?php echo e($item['children_title'] ?? 'Opciones'); ?></span>
                                        <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $childBadgeCount = $child['badge_count'] ?? (($child['pending_badge'] ?? false) ? $pendingOrderBadgeCount : null); ?>
                                            <a class="button nav-button sub-nav-button <?php echo e($child['active'] ? 'active' : ''); ?>" href="<?php echo e($child['url']); ?>"><?php echo e($child['label']); ?><?php if($childBadgeCount !== null): ?><span class="nav-pending-badge <?php echo e($childBadgeCount ? '' : 'is-empty'); ?>"><?php echo e($childBadgeCount); ?></span><?php endif; ?></a>
...
<?php /**PATH C:\laragon\www\Revision OC Software\resources\views\components\app-shell.blade.php ENDPATH**/ ?>